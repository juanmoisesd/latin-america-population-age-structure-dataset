...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Latin America Population Age Structure Dataset: 11 Countries 2000-2023. GitHub. https://github.com/juanmoisesd/latin-america-population-age-structure-dataset
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Latin America Population Age Structure Dataset: 11 Countries 2000-2023." GitHub. https://github.com/juanmoisesd/latin-america-population-age-structure-dataset.
```

### BibTeX
```bibtex
@misc{delaserna2026_latinamerica,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {Latin America Population Age Structure Dataset: 11 Countries 2000-2023},
  year         = {2026},
...
TI  - Latin America Population Age Structure Dataset: 11 Countries 2000-2023
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/latin-america-population-age-structure-dataset
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Latin America Population Age Structure Dataset: 11 Countries 2000-2023. GitHub; 2026. Available: https://github.com/juanmoisesd/latin-america-population-age-structure-dataset. ORCID: 0000-0002-8401-8018.
```
