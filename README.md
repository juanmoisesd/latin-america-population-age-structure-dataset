...
[![Pages](https://img.shields.io/badge/Live-Dashboard-brightgreen)](https://juanmoisesd.github.io/latin-america-population-age-structure-dataset/)
...
Demographic dataset: Population age structure in Latin America (11 countries, 2000-2023). Static microsite with 907 pages. DOI: 10.17632/ygkmshr5fv.1
...
| Zenodo DOI | [doi.org/10.5281/zenodo.18891177](https://doi.org/10.5281/zenodo.18891177) |
...
Also cite the dataset: https://doi.org/10.17632/ygkmshr5fv.1
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Demographic dataset: Population age structure in Latin America (11 countries, 2000-2023). Static microsite with 907 pages. DOI: 10.17632/ygkmshr5fv.1* [Dataset]. GitHub. https://github.com/juanmoisesd/latin-america-population-age-structure-dataset

**BibTeX**
```bibtex
@dataset{delaserna2025_latin_america_population_age_s,
