# Latin America Population Age Structure Dataset (2000–2060)

[![DOI](https://img.shields.io/badge/DOI-10.17632%2Fygkmshr5fv.1-blue?logo=doi)](https://doi.org/10.17632/ygkmshr5fv.1)
...
Open dataset on population age structure for 20 Latin American countries (2000-2060). FAIR principles, CC0 license. DOI: 10.17632/ygkmshr5fv.1
...
```bibtex
@misc{delaserna2024_latin_america_popula,
  author    = {de la Serna Tuya, Juan Moisés},
  title     = {Latin America Population Age Structure Dataset (2000–2060)},
  year      = {2024},
...
**APA:** de la Serna Tuya, J. M. (2024). *Latin America Population Age Structure Dataset (2000–2060)*. https://doi.org/10.17632/ygkmshr5fv.1
...
> de la Serna, J. M. (2026). *Latin America Population Age Structure Dataset*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/latin-america-population-age-structure-dataset 10.5281/zenodo.19145316

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **latin america population age structure dataset**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
